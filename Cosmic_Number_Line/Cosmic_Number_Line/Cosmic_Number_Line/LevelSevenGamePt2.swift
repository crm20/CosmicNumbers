...
class LevelSevenGamePt2: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        astronautPlaceLabel.text = "Solve \(num1) − \(num2)!\n\nAwesome!\nNow drag Astronaut Tommy \(num2) to the left"
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if(tryAgainVC != nil){
            tryAgainVC?.previousP2SevenVCNum=desiredNumber
            tryAgainVC?.previousP2SevenSelectedNum=selectednumber
            tryAgainVC?.previousP2SevenNum1=num1
            tryAgainVC?.previousP2SevenNum2=num2
            tryAgainVC?.previousP2Seven=true
